...
public class Main {
	...
	public static void main(String[] args) {
		...
		if(startAsEditor){
			...
			GameWindow gameWindow = new GameWindow(512, 512, Color.BLACK, "Dino Dungeons Editor", 24);
			gameWindow.run(new Editor());
		}
		else{
			GameWindowConstants.DEFAULT_SCREEN_WIDTH = 360;
			GameWindowConstants.DEFAULT_SCREEN_HEIGHT = 180;
			GameWindow gameWindow = new GameWindow(720, 360, Color.BLACK, "Dino Dungeons", 24);
